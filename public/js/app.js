...
function _getMedia() {
  _getMedia = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(deviceId) {
...
function _handleCameraChange() {
  _handleCameraChange = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
...
function _initCall() {
  _initCall = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
...
function showRoom(newCount) {
  var presentRoom = call.querySelector("#presentRoom");
  var presentName = call.querySelector("#presentName");
  presentRoom.innerText = "Room: ".concat(roomName, " (").concat(newCount, "\uBA85)");
  presentName.innerText = "Nickname: ".concat(nickname);
  var leaveBtn = call.querySelector("#leaveBtn");
...
function _handleWelcomeSubmit() {
  _handleWelcomeSubmit = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(event) {
    var _wantRoom$;
    var roomInput, nickInput, wantRoom, currentCount;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          event.preventDefault();
          roomInput = welcomeForm.querySelector("#roomInput");
          nickInput = welcomeForm.querySelector("#nickInput");
          console.log("submit", roomsInfo);
          wantRoom = roomsInfo.filter(function (room) {
            return room.roomName === roomInput.value;
          });
          currentCount = (_wantRoom$ = wantRoom[0]) === null || _wantRoom$ === void 0 ? void 0 : _wantRoom$.countUsers;
...
var chatForm = chat.querySelector("form");
...
function handleRoomClick(event) {
  event.preventDefault();
  var roomInput = welcomeForm.querySelector("#roomInput");
  roomInput.value = event.target.value;
}
socket.on("welcome", /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(user, newCount) {
    var offer, presentRoom;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          presentRoom = call.querySelector("#presentRoom");
          presentRoom.innerText = "Room: ".concat(roomName, " (").concat(newCount, ")");
...
socket.on("new_count", function (nickname, newCount) {
  var presentRoom = call.querySelector("#presentRoom");
  presentRoom.innerText = "Room: ".concat(roomName, " (").concat(newCount, ")");
  addMessage("".concat(nickname, " Left \u3160\u3160"));
});
socket.on("bye", function (user, newCount) {
  var presentRoom = call.querySelector("#presentRoom");
  presentRoom.innerText = "Room: ".concat(roomName, " (").concat(newCount, ")");
  addMessage("".concat(user, " Left \u3160\u3160"));
});
